...
public class NewItemActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void fillWithString(/*List<Product> myList*/) {
        for(int i = 0; i < 10; i++){
            Product prod = new Product("" + i, "product" + i, i, "http://www.runnersworld.com/sites/runnersworld.com/files/styles/slideshow-desktop/public/nike-zoom-span_m_400.jpg");
